            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">Email ID</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo 'Email ID'; ?></a>
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">Contact</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo 'Contact'; ?></a>
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">Status</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo 'Status'; ?></a>
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>">City</a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo 'City'; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $employee['email_id']; ?></td>
                  <td class="text-left"><?php echo $employee['contact']; ?></td>
